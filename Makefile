...
COPY =build/cert_generator svc-account-session svc-aggregation svc-api svc-events svc-fabrics svc-telemetry svc-managers svc-systems svc-license svc-task svc-update lib-dmtf lib-messagebus lib-persistence-manager lib-utilities plugin-redfish lib-rest-client plugin-dell plugin-unmanaged-racks plugin-lenovo
