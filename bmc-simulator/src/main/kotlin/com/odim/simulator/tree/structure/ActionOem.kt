...
open class ActionOem(actionType: ActionType) : ActionElement(actionType), Searchable {
    ...
    override fun getActionQualifiedName() = "CustomCompany.Oem.${actionType.actionName}"

    override fun toLink() = "${this.parent!!.toLink()}/Actions/Oem/${getActionQualifiedName()}"
}
