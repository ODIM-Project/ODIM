...
class LinkableResource(type: Type) : LinkableElement(type) {
    private var element: TreeElement? = null

    fun getElement() = this.element
    ...
    override fun isThereLink(element: TreeElement, linkTo: TreeElement) = element == this.element
}
