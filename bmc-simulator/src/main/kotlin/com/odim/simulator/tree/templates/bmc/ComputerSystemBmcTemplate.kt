...
import com.odim.simulator.tree.templates.redfish.ComputerSystemTemplate

@Template(COMPUTER_SYSTEM)
open class ComputerSystemBmcTemplate : ComputerSystemTemplate() {
    init {
        version(BMC_1_0, V1_13_0, resourceObject(
                "Actions" to Actions(
                        Action(ActionType.RESET, "ResetType", mutableListOf(
                                "On",
                                "ForceOff",
                                "GracefulShutdown",
                                "ForceRestart",
