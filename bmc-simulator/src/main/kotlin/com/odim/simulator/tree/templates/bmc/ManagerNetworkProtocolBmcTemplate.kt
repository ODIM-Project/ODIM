...
import com.odim.simulator.tree.templates.redfish.ManagerNetworkProtocolTemplate

@Template(MANAGER_NETWORK_PROTOCOL)
open class ManagerNetworkProtocolBmcTemplate : ManagerNetworkProtocolTemplate() {
    init {
        version(BMC_1_0, RedfishVersion.V1_6_1)
    }
}
