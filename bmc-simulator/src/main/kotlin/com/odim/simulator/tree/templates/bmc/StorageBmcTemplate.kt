...
import com.odim.simulator.tree.templates.redfish.StorageTemplate

@Template(STORAGE)
open class StorageBmcTemplate : StorageTemplate() {
    init {
        version(BMC_1_0, V1_9_0, resourceObject(
                "DrivesCollection" to ResourceCollection(DRIVES_COLLECTION),
        ))
    }
}
