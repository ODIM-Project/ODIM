...
import com.odim.simulator.tree.templates.redfish.embedded.MemorySummaryTemplate

@EmbeddedObjectTemplate(MEMORY_SUMMARY)
open class MemorySummaryBmcTemplate : MemorySummaryTemplate() {
    init {
        version(BMC_1_0, V1_8_0, embeddedObject(
                "TotalSystemPersistentMemoryGiB" to 0
        ))
    }
}
