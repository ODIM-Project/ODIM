...
import com.odim.simulator.tree.structure.ResourceCollectionType.EXTERNAL_ACCOUNT_PROVIDERS_COLLECTION
import com.odim.simulator.tree.structure.ResourceCollectionType.MANAGER_ACCOUNTS_COLLECTION
import com.odim.simulator.tree.structure.ResourceCollectionType.ROLES_COLLECTION
import com.odim.simulator.tree.structure.ResourceType.ACCOUNT_SERVICE
import com.odim.simulator.tree.structure.ResourceType.PRIVILEGE_REGISTRY

/**
 * This is generated class. Please don't edit it's contents.
 */
@Template(ACCOUNT_SERVICE)
open class AccountServiceTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to "AccountService",
                "Description" to "Account Service Description",
                "Name" to "Account Service",
                "Status" to embeddedObject(STATUS),
                "ServiceEnabled" to null,
                "AuthFailureLoggingThreshold" to 0,
                "MinPasswordLength" to 0,
                "MaxPasswordLength" to 0,
                "AccountLockoutThreshold" to null,
                "AccountLockoutDuration" to null,
                "AccountLockoutCounterResetAfter" to 0,
                "Accounts" to ResourceCollection(MANAGER_ACCOUNTS_COLLECTION),
                "Roles" to ResourceCollection(ROLES_COLLECTION)
        ))
        ...
        version(V1_1_0, V1_0_3, resourceObject(
                "PrivilegeMap" to LinkableResource(PRIVILEGE_REGISTRY)
        ))
        ...
        version(V1_3_0, V1_2_2, resourceObject(
                "LocalAccountAuth" to "Enabled",
                "LDAP" to embeddedObject(EXTERNAL_ACCOUNT_PROVIDER),
                "ActiveDirectory" to embeddedObject(EXTERNAL_ACCOUNT_PROVIDER),
                "AdditionalExternalAccountProviders" to
                        ResourceCollection(EXTERNAL_ACCOUNT_PROVIDERS_COLLECTION)
        ))
        ...
        version(V1_5_0, V1_4_1, resourceObject(
                "AccountLockoutCounterResetEnabled" to false
        ))
