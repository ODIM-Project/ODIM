 ...
 */
@Template(BOOT_OPTION)
open class BootOptionTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Boot Option Description",
                "Name" to "Boot Option",
                "BootOptionReference" to null,
                "DisplayName" to null,
                "BootOptionEnabled" to null,
