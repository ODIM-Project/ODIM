...
import com.odim.simulator.tree.structure.ResourceCollectionType.MEMORY_CHUNKS_COLLECTION
 ...
 */
@Template(CAPACITY_SOURCE)
open class CapacitySourceTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Capacity Source Description",
                "Name" to "Capacity Source",
                "ProvidedCapacity" to embeddedObject(CAPACITY),
                "ProvidedClassOfService" to LinkableResource(CLASS_OF_SERVICE),
                "ProvidingVolumes" to ResourceCollection(VOLUMES_COLLECTION),
                "ProvidingPools" to ResourceCollection(STORAGE_POOLS_COLLECTION),
                "ProvidingDrives" to ResourceCollection(DRIVES_COLLECTION)
        ))
        ...
        version(V1_1_0, V1_0_2, resourceObject(
                "ProvidingMemoryChunks" to ResourceCollection(MEMORY_CHUNKS_COLLECTION),
                "ProvidingMemory" to ResourceCollection(MEMORY_COLLECTION)
        ))
        version(V1_1_1, V1_1_0)
        version(V1_1_2, V1_1_1, resourceObject(
                "Actions" to Actions()
        ))
