 ...
 */
@Template(CONSISTENCY_GROUP)
open class ConsistencyGroupTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Consistency Group Description",
                "Name" to "Consistency Group",
                "IsConsistent" to null,
                "ConsistencyMethod" to null,
