 ...
 */
@Template(DATA_PROTECTION_LINE_OF_SERVICE)
open class DataProtectionLineOfServiceTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Data Protection Line Of Service Description",
                "Name" to "Data Protection Line Of Service",
                "RecoveryGeographicObjective" to null,
                "RecoveryPointObjectiveTime" to null,
                "RecoveryTimeObjective" to null,
                "ReplicaType" to null,
                "MinLifetime" to null,
                "IsIsolated" to false,
                "Schedule" to embeddedObject(SCHEDULE),
                "ReplicaClassOfService" to LinkableResource(CLASS_OF_SERVICE),
                "ReplicaAccessLocation" to embeddedObject(RESOURCE_LOCATION)
        ))
