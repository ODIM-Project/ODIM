 ...
 */
@Template(DATA_SECURITY_LOS_CAPABILITIES)
open class DataSecurityLoSCapabilitiesTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to "DataSecurityLoSCapabilities",
                "Description" to "Data Security Lo S Capabilities Description",
                "Name" to "Data Security Lo S Capabilities",
                "Identifier" to embeddedObject(RESOURCE_IDENTIFIER),
                "SupportedMediaEncryptionStrengths" to embeddedArray(),
                "SupportedChannelEncryptionStrengths" to embeddedArray(),
                "SupportedHostAuthenticationTypes" to embeddedArray(),
                "SupportedUserAuthenticationTypes" to embeddedArray(),
                "SupportedSecureChannelProtocols" to embeddedArray(),
                "SupportedAntivirusScanPolicies" to embeddedArray(),
                "SupportedAntivirusEngineProviders" to embeddedArray(),
                "SupportedDataSanitizationPolicies" to embeddedArray(),
                "SupportedLinesOfService" to LinkableResourceArray(DATA_SECURITY_LINE_OF_SERVICE)
        ))
