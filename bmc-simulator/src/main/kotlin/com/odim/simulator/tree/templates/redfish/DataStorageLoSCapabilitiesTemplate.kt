 ...
 */
@Template(DATA_STORAGE_LOS_CAPABILITIES)
open class DataStorageLoSCapabilitiesTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to "DataStorageLoSCapabilities",
                "Description" to "Data Storage Lo S Capabilities Description",
                "Name" to "Data Storage Lo S Capabilities",
                "Identifier" to embeddedObject(RESOURCE_IDENTIFIER),
                "SupportedAccessCapabilities" to embeddedArray(),
                "SupportedRecoveryTimeObjectives" to embeddedArray(),
                "SupportedProvisioningPolicies" to embeddedArray(),
                "SupportsSpaceEfficiency" to false,
                "SupportedLinesOfService" to LinkableResourceArray(DATA_STORAGE_LINE_OF_SERVICE)
        ))
        ...
        version(V1_2_0, V1_1_1, resourceObject(
                "MaximumRecoverableCapacitySourceCount" to null
        ))
