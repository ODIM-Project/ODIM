 ...
 */
@Template(IO_CONNECTIVITY_LINE_OF_SERVICE)
open class IOConnectivityLineOfServiceTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "I O Connectivity Line Of Service Description",
                "Name" to "I O Connectivity Line Of Service",
                "AccessProtocols" to embeddedArray()
        ))
        version(V1_0_1, V1_0_0)
        version(V1_0_2, V1_0_1)
        version(V1_0_3, V1_0_2)
        version(V1_1_0, V1_0_0, resourceObject(
                "MaxBytesPerSecond" to null,
                "MaxIOPS" to null
        ))
