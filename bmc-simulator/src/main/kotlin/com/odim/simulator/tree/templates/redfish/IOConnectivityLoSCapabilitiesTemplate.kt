 ...
 */
@Template(IO_CONNECTIVITY_LOS_CAPABILITIES)
open class IOConnectivityLoSCapabilitiesTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to "IOConnectivityLoSCapabilities",
                "Description" to "I O Connectivity Lo S Capabilities Description",
                "Name" to "I O Connectivity Lo S Capabilities",
                "Identifier" to embeddedObject(RESOURCE_IDENTIFIER),
                "SupportedAccessProtocols" to embeddedArray(),
                "MaxSupportedBytesPerSecond" to null,
                "SupportedLinesOfService" to LinkableResourceArray(IO_CONNECTIVITY_LINE_OF_SERVICE)
        ))
