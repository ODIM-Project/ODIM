 ...
 */
@Template(IO_PERFORMANCE_LINE_OF_SERVICE)
open class IOPerformanceLineOfServiceTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "I O Performance Line Of Service Description",
                "Name" to "I O Performance Line Of Service",
                "IOOperationsPerSecondIsLimited" to false,
                "SamplePeriod" to null,
                "MaxIOOperationsPerSecondPerTerabyte" to null,
                "AverageIOOperationLatencyMicroseconds" to null,
                "IOWorkload" to embeddedObject(IO_WORKLOAD)
        ))
