 ...
 */
@Template(IO_PERFORMANCE_LOS_CAPABILITIES)
open class IOPerformanceLoSCapabilitiesTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to "IOPerformanceLoSCapabilities",
                "Description" to "I O Performance Lo S Capabilities Description",
                "Name" to "I O Performance Lo S Capabilities",
                "Identifier" to embeddedObject(RESOURCE_IDENTIFIER),
                "IOLimitingIsSupported" to false,
                "MinSamplePeriod" to null,
                "MaxSamplePeriod" to null,
                "MinSupportedIoOperationLatencyMicroseconds" to null,
                "SupportedIOWorkloads" to embeddedArray(IO_WORKLOAD),
                "SupportedLinesOfService" to LinkableResourceArray(IO_PERFORMANCE_LINE_OF_SERVICE)
        ))
