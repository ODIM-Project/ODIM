...
import com.odim.simulator.tree.structure.EmbeddedObjectType.JOB_SERVICE_CAPABILITIES
 ...
 */
@Template(JOB_SERVICE)
open class JobServiceTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to "JobService",
                "Description" to "Job Service Description",
                "Name" to "Job Service",
                "DateTime" to null,
                "ServiceEnabled" to null,
                "ServiceCapabilities" to embeddedObject(JOB_SERVICE_CAPABILITIES),
                "Status" to embeddedObject(STATUS),
                "Log" to LinkableResource(LOG_SERVICE),
                "Jobs" to ResourceCollection(JOBS_COLLECTION),
                "Actions" to Actions()
        ))
