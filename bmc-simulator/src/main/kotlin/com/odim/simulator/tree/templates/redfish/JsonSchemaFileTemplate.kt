...
import com.odim.simulator.tree.structure.EmbeddedObjectType.JSON_SCHEMA_FILE_LOCATION
 ...
 */
@Template(JSON_SCHEMA_FILE)
open class JsonSchemaFileTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Json Schema File Description",
                "Name" to "Json Schema File",
                "Languages" to embeddedArray(),
                "Schema" to "",
                "Location" to embeddedArray(JSON_SCHEMA_FILE_LOCATION)
        ))
