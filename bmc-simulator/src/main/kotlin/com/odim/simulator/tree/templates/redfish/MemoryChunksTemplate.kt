 ...
 */
@Template(MEMORY_CHUNKS)
open class MemoryChunksTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Memory Chunks Description",
                "Name" to "Memory Chunks",
                "MemoryChunkSizeMiB" to null,
                "AddressRangeType" to null,
                "IsMirrorEnabled" to false,
                "IsSpare" to false,
                "InterleaveSets" to embeddedArray(INTERLEAVE_SET)
        ))
        ...
        version(V1_3_0, V1_2_4, resourceObject(
                "AddressRangeOffsetMiB" to null,
