...
import com.odim.simulator.tree.structure.EmbeddedObjectType.MEMORY_SET
 ...
 */
@Template(MEMORY_DOMAIN)
open class MemoryDomainTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Memory Domain Description",
                "Name" to "Memory Domain",
                "AllowsMemoryChunkCreation" to false,
                "AllowsBlockProvisioning" to false,
                "MemoryChunks" to ResourceCollection(MEMORY_CHUNKS_COLLECTION),
                "InterleavableMemorySets" to embeddedArray(MEMORY_SET)
        ))
        ...
        version(V1_1_0, V1_0_1, resourceObject(
                "AllowsMirroring" to false,
                "AllowsSparing" to false
        ))
        ...
        version(V1_3_0, V1_2_3, resourceObject(
                "Links" to embeddedObject(
                        "Oem" to embeddedObject(),
                        "MediaControllers" to LinkableResourceArray(MEDIA_CONTROLLER)
                )
        ))
    }
}
