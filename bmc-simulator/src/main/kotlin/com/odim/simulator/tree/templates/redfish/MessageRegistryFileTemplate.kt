 ...
 */
@Template(MESSAGE_REGISTRY_FILE)
open class MessageRegistryFileTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Message Registry File Description",
                "Name" to "Message Registry File",
                "Languages" to embeddedArray(),
                "Registry" to "",
                "Location" to embeddedArray(MESSAGE_REGISTRY_FILE_LOCATION)
        ))
