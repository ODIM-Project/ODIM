...
import com.odim.simulator.tree.structure.EmbeddedObjectType.METRIC
import com.odim.simulator.tree.structure.EmbeddedObjectType.METRIC_REPORT_DEFINITION_WILDCARD
 ...
 */
@Template(METRIC_REPORT_DEFINITION)
open class MetricReportDefinitionTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Metric Report Definition Description",
                "Name" to "Metric Report Definition",
                "MetricReportDefinitionType" to null,
                "Schedule" to embeddedObject(SCHEDULE),
                "ReportActions" to embeddedArray(),
                "ReportUpdates" to "Overwrite",
                "AppendLimit" to 0,
                "Status" to embeddedObject(STATUS),
                "Wildcards" to embeddedArray(METRIC_REPORT_DEFINITION_WILDCARD),
                "MetricProperties" to embeddedArray(),
                "Metrics" to embeddedArray(METRIC),
                "MetricReport" to LinkableResource(METRIC_REPORT),
                "Actions" to Actions()
        ))
        ...
        version(V1_2_0, V1_1_1, resourceObject(
                "SuppressRepeatedMetricValue" to null,
                "MetricReportHeartbeatInterval" to null,
                "MetricReportDefinitionEnabled" to null,
                "Links" to embeddedObject(
                        "Oem" to embeddedObject(),
                        "Triggers" to LinkableResourceArray(TRIGGERS)
                )
        ))
