...
import com.odim.simulator.tree.structure.EmbeddedObjectType.METRIC_REPORT_METRIC_VALUE
...
open class MetricReportTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Metric Report Description",
                "Name" to "Metric Report",
                "MetricReportDefinition" to LinkableResource(METRIC_REPORT_DEFINITION),
                "ReportSequence" to "",
                "MetricValues" to embeddedArray(METRIC_REPORT_METRIC_VALUE),
                "Actions" to Actions()
        ))
