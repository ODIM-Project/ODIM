...
import com.odim.simulator.tree.structure.EmbeddedObjectType.NET_DEV_FUNC_MAX_B_W_ALLOC
import com.odim.simulator.tree.structure.EmbeddedObjectType.NET_DEV_FUNC_MIN_B_W_ALLOC
import com.odim.simulator.tree.structure.EmbeddedObjectType.STATUS
import com.odim.simulator.tree.structure.EmbeddedObjectType.SUPPORTED_LINK_CAPABILITIES
 ...
 */
@Template(NETWORK_PORT)
open class NetworkPortTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Network Port Description",
                "Name" to "Network Port",
                "Status" to embeddedObject(STATUS),
                "PhysicalPortNumber" to null,
                "LinkStatus" to null,
                "SupportedLinkCapabilities" to embeddedArray(SUPPORTED_LINK_CAPABILITIES),
                "ActiveLinkTechnology" to null,
                "SupportedEthernetCapabilities" to embeddedArray(),
                "NetDevFuncMinBWAlloc" to embeddedArray(NET_DEV_FUNC_MIN_B_W_ALLOC),
                "NetDevFuncMaxBWAlloc" to embeddedArray(NET_DEV_FUNC_MAX_B_W_ALLOC),
                "AssociatedNetworkAddresses" to embeddedArray(),
                "EEEEnabled" to null,
                "WakeOnLANEnabled" to null,
                "PortMaximumMTU" to null,
                "FlowControlStatus" to null,
                "FlowControlConfiguration" to null,
        ...
        version(V1_2_0, V1_1_1, resourceObject(
                "FCPortConnectionType" to null,
                "NumberDiscoveredRemotePorts" to null,
                "MaxFrameSize" to null,
                "VendorId" to null,
                "FCFabricName" to null,
                "CurrentLinkSpeedMbps" to null
        ))
