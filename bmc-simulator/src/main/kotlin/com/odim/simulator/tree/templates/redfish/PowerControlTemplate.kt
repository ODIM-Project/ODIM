...
import com.odim.simulator.tree.structure.EmbeddedObjectType.POWER_LIMIT
import com.odim.simulator.tree.structure.EmbeddedObjectType.POWER_METRIC
 ...
 */
@Template(POWER_CONTROL)
open class PowerControlTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Name" to null,
                "PowerConsumedWatts" to null,
                "PowerRequestedWatts" to null,
                "PowerAvailableWatts" to null,
                "PowerCapacityWatts" to null,
                "PowerAllocatedWatts" to null,
                "PowerMetrics" to embeddedObject(POWER_METRIC),
                "PowerLimit" to embeddedObject(POWER_LIMIT),
