...
import com.odim.simulator.tree.structure.ActionType.POWER_SUPPLY_RESET
 ...
 */
@Template(POWER)
open class PowerTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                ...
                "Name" to "Power",
                "PowerControl" to EmbeddedResourceArray(POWER_CONTROL),
                "Voltages" to EmbeddedResourceArray(VOLTAGE),
                "PowerSupplies" to EmbeddedResourceArray(POWER_SUPPLY),
        ...
        version(V1_6_0, V1_5_4, embeddedObject(
                "Actions" to Actions(
                        Action(POWER_SUPPLY_RESET)
                )
        ))
