 ...
 */
@Template(PRIVILEGE_REGISTRY)
open class PrivilegeRegistryTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Privilege Registry Description",
                "Name" to "Privilege Registry",
                "PrivilegesUsed" to embeddedArray(),
                "OEMPrivilegesUsed" to embeddedArray(),
                "Mappings" to embeddedArray(MAPPING)
        ))
