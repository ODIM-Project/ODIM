 ...
 */
@Template(REDUNDANCY)
open class RedundancyTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Name" to "",
                "Mode" to null,
                "MaxNumSupported" to null,
                "MinNumNeeded" to null,
                "Status" to embeddedObject(STATUS),
                "RedundancySet" to LinkableResourceArray(ANY)
        ))
