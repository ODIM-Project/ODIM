 ...
 */
@Template(SIGNATURE)
open class SignatureTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Signature Description",
                "Name" to "Signature",
                "SignatureTypeRegistry" to null,
                "SignatureType" to null,
                "SignatureString" to null,
