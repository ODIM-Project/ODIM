 ...
 */
@Template(SIMPLE_STORAGE)
open class SimpleStorageTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Simple Storage Description",
                "Name" to "Simple Storage",
                "UefiDevicePath" to null,
                "Devices" to embeddedArray(DEVICE),
        ...
        version(V1_3_0, V1_2_3, embeddedObject(
                "Links" to embeddedObject(
                        "Storage" to LinkableResource(STORAGE)
                )
        ))
    }
}
