 ...
 */
@Template(SOFTWARE_INVENTORY)
open class SoftwareInventoryTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Software Inventory Description",
                "Name" to "Software Inventory",
        ...
        version(V1_1_0, V1_0_1, resourceObject(
                "SoftwareId" to "",
                "LowestSupportedVersion" to null,
                "UefiDevicePaths" to embeddedArray(),
