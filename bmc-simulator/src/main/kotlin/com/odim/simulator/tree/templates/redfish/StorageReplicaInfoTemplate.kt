...
import com.odim.simulator.tree.structure.ResourceType.STORAGE_REPLICA_INFO

/**
 * This is generated class. Please don't edit it's contents.
 */
@Template(STORAGE_REPLICA_INFO)
open class StorageReplicaInfoTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "Storage Replica Info Description",
                "Name" to "Storage Replica Info"
        ))
