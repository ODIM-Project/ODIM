...
open class TaskServiceTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to "TaskService",
                "Description" to "Task Service Description",
                "Name" to "Task Service",
                "CompletedTaskOverWritePolicy" to "Manual",
                "DateTime" to null,
                "LifeCycleEventOnTaskStateChange" to false,
                "ServiceEnabled" to null,
                "Status" to embeddedObject(STATUS),
                "Tasks" to ResourceCollection(TASKS_COLLECTION)
        ))
