...
import com.odim.simulator.tree.structure.EmbeddedObjectType.TASK_PAYLOAD
...
import com.odim.simulator.tree.structure.ResourceCollectionType.TASKS_COLLECTION
 ...
 */
@Template(TASK)
open class TaskTemplate : ResourceTemplate() {
    init {
        ...
        version(V1_3_0, V1_2_1, resourceObject(
                "Payload" to embeddedObject(TASK_PAYLOAD),
        ...
        version(V1_5_0, V1_4_3, resourceObject(
                "SubTasks" to ResourceCollection(TASKS_COLLECTION)
        ))
    }
}
