...
open class TemperatureTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                ...
                "MinReadingRangeTemp" to null,
                "MaxReadingRangeTemp" to null,
        ...
        version(V1_4_0, V1_3_2, resourceObject(
                "DeltaReadingCelsius" to null,
                "DeltaPhysicalContext" to "Room",
        ...
        version(V1_6_0, V1_5_3, resourceObject(
                "UpperThresholdUser" to null,
                "LowerThresholdUser" to null
        ))
