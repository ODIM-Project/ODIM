 ...
 */
@Template(THERMAL)
open class ThermalTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to "Thermal",
                "Description" to "Thermal Description",
                "Name" to "Thermal",
                "Temperatures" to EmbeddedResourceArray(TEMPERATURE),
                "Fans" to EmbeddedResourceArray(FAN),
