 ...
 */
@Template(VLAN_NETWORK_INTERFACE)
open class VLanNetworkInterfaceTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, resourceObject(
                "Oem" to embeddedObject(),
                "Id" to 0,
                "Description" to "V Lan Network Interface Description",
                "Name" to "V Lan Network Interface",
                "VLANEnable" to null,
                "VLANId" to null
        ))
