 ...
 */
@EmbeddedObjectTemplate(ACCOUNT_SERVICE_LDAP_SERVICE)
open class AccountServiceLDAPServiceTemplate : ResourceTemplate() {
    init {
        version(V1_3_0, embeddedObject(
                "SearchSettings" to embeddedObject(ACCOUNT_SERVICE_LDAP_SEARCH_SETTINGS),
