 ...
 */
@EmbeddedObjectTemplate(ADDRESS_POOL_ETHERNET)
open class AddressPoolEthernetTemplate : ResourceTemplate() {
    init {
        version(V1_1_0, embeddedObject(
                "IPv4" to null,
                "BGPEvpn" to null,
                "EBGP" to null,
                "MultiProtocolIBGP" to null,
                "MultiProtocolEBGP" to null,
                "BFDSingleHopOnly" to null
        ))
    }
}
