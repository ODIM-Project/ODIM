 ...
 */
@EmbeddedObjectTemplate(ALARM_TRIPS)
open class AlarmTripsTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "Temperature" to null,
                "SpareBlock" to null,
                "UncorrectableECCError" to null,
                "CorrectableECCError" to null,
                "AddressParityError" to null
        ))
    }
}
