 ...
 */
@EmbeddedObjectTemplate(CHAP_INFORMATION)
open class CHAPInformationTemplate : ResourceTemplate() {
    init {
        version(V1_2_0, embeddedObject(
                "InitiatorCHAPUser" to null,
                "InitiatorCHAPPassword" to null,
                "TargetCHAPUser" to null,
                "TargetPassword" to null
        ))
        version(V1_2_2, V1_2_0)
        version(V1_3_0, V1_2_2, embeddedObject(
                "CHAPUser" to null,
                "CHAPPassword" to null,
                "TargetCHAPPassword" to null
        ))
    }
}
