...
import com.odim.simulator.tree.structure.EmbeddedObjectType.CAPABILITY
 ...
 */
@EmbeddedObjectTemplate(CAPABILITY)
open class CapabilityTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "CapabilitiesObject" to LinkableResource(ANY),
                "UseCase" to "ComputerSystemComposition"
        ))
    }
}
