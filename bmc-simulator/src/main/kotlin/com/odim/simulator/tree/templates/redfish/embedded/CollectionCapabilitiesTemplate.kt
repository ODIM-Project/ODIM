...
import com.odim.simulator.tree.structure.EmbeddedObjectType.COLLECTION_CAPABILITIES
 ...
 */
@EmbeddedObjectTemplate(COLLECTION_CAPABILITIES)
open class CollectionCapabilitiesTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "Capabilities" to embeddedArray(CAPABILITY),
                "Links" to embeddedObject(
                        "Oem" to embeddedObject(),
                        "TargetCollection" to LinkableResource(ANY),
