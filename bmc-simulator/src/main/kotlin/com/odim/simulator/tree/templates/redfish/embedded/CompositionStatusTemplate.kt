 ...
 */
@EmbeddedObjectTemplate(COMPOSITION_STATUS)
open class CompositionStatusTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "Reserved" to null,
                "CompositionState" to null
        ))
        version(V1_1_0, V1_0_0, embeddedObject(
                "SharingCapable" to null,
                "SharingEnabled" to null,
                "MaxCompositions" to null,
                "NumberOfCompositions" to null
        ))
    }
}
