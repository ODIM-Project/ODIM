 ...
 */
@EmbeddedObjectTemplate(CONTROLLERS)
open class ControllersTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "FirmwarePackageVersion" to null,
                "ControllerCapabilities" to embeddedObject(CONTROLLER_CAPABILITIES)
        ))
