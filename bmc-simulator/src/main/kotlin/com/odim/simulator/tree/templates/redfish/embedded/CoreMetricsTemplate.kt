...
import com.odim.simulator.tree.structure.EmbeddedObjectType.C_STATE_RESIDENCY
 ...
 */
@EmbeddedObjectTemplate(CORE_METRICS)
open class CoreMetricsTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "CoreId" to null,
                "InstructionsPerCycle" to null,
                "UnhaltedCycles" to null,
                "MemoryStallCount" to null,
                "IOStallCount" to null,
                "CoreCache" to embeddedArray(CACHE_METRICS),
                "CStateResidency" to embeddedArray(C_STATE_RESIDENCY)
        ))
    }
}
