 ...
 */
@EmbeddedObjectTemplate(CURRENT_PERIOD)
open class CurrentPeriodTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "BlocksRead" to null,
                "BlocksWritten" to null
        ))
        version(V1_4_0, V1_0_0, embeddedObject(
                "CorrectableECCErrorCount" to null,
                "UncorrectableECCErrorCount" to null
        ))
    }
}
