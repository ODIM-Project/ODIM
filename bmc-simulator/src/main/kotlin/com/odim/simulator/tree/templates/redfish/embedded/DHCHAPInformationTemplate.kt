 ...
 */
@EmbeddedObjectTemplate(DHCHAP_INFORMATION)
open class DHCHAPInformationTemplate : ResourceTemplate() {
    init {
        version(V1_3_0, embeddedObject(
                "LocalDHCHAPAuthSecret" to null,
                "PeerDHCHAPAuthSecret" to null
        ))
    }
}
