...
import com.odim.simulator.tree.structure.EmbeddedObjectType.DHCP
 ...
 */
@EmbeddedObjectTemplate(DHCP)
open class DHCPTemplate : ResourceTemplate() {
    init {
        version(V1_1_0, embeddedObject(
                "DHCPRelayEnabled" to null,
                "DHCPInterfaceMTUBytes" to null,
                "DHCPServer" to embeddedArray()
        ))
    }
}
