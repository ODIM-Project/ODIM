 ...
 */
@EmbeddedObjectTemplate(DHCPV4_CONFIGURATION)
open class DHCPv4ConfigurationTemplate : ResourceTemplate() {
    init {
        version(V1_4_0, embeddedObject(
                "DHCPEnabled" to null,
                "UseDNSServers" to null,
                "UseDomainName" to null,
                "UseGateway" to null,
                "UseNTPServers" to null,
                "UseStaticRoutes" to null
        ))
        version(V1_5_0, V1_4_0, embeddedObject(
                "FallbackAddress" to null
        ))
    }
}
