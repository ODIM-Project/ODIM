...
import com.odim.simulator.tree.structure.EmbeddedObjectType.ENGINE_ID
import com.odim.simulator.tree.structure.Resource.Companion.embeddedObject

/**
 * This is generated class. Please don't edit it's contents.
 */
@EmbeddedObjectTemplate(ENGINE_ID)
open class EngineIdTemplate : ResourceTemplate() {
    init {
        version(V1_5_0, embeddedObject(
                "PrivateEnterpriseId" to null,
                "EnterpriseSpecificMethod" to null
        ))
        version(V1_6_0, V1_5_0, embeddedObject(
                "ArchitectureId" to null
        ))
    }
}
