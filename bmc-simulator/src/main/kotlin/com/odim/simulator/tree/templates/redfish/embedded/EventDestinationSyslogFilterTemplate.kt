 ...
 */
@EmbeddedObjectTemplate(EVENT_DESTINATION_SYSLOG_FILTER)
open class EventDestinationSyslogFilterTemplate : ResourceTemplate() {
    init {
        version(V1_9_0, embeddedObject(
                "LowestSeverity" to null,
                "LogFacilities" to embeddedArray()
        ))
    }
}
