 ...
 */
@EmbeddedObjectTemplate(EXTERNAL_ACCOUNT_PROVIDER_AUTHENTICATION)
open class ExternalAccountProviderAuthenticationTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "AuthenticationType" to null,
                "Username" to "",
                "Password" to null,
                "Token" to null,
                "KerberosKeytab" to null,
