...
import com.odim.simulator.tree.structure.EmbeddedObjectType.BOOT_TARGETS
 ...
 */
@EmbeddedObjectTemplate(FIBRE_CHANNEL)
open class FibreChannelTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "PermanentWWPN" to null,
                "PermanentWWNN" to null,
                "WWPN" to null,
                "WWNN" to null,
                "WWNSource" to null,
                "FCoELocalVLANId" to null,
                "AllowFIPVLANDiscovery" to null,
                "FCoEActiveVLANId" to null,
                "BootTargets" to embeddedArray(BOOT_TARGETS)
        ))
        version(V1_3_0, V1_0_0, embeddedObject(
                "FibreChannelId" to null
        ))
    }
}
