 ...
 */
@EmbeddedObjectTemplate(FPGA_RECONFIGURATION_SLOT)
open class FpgaReconfigurationSlotTemplate : ResourceTemplate() {
    init {
        version(V1_4_0, embeddedObject(
                "SlotId" to null,
                "UUID" to null,
                "ProgrammableFromHost" to null,
                "AccelerationFunction" to LinkableResource(ACCELERATION_FUNCTION)
        ))
    }
}
