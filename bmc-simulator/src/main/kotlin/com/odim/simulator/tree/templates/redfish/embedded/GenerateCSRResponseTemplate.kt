...
import com.odim.simulator.tree.structure.EmbeddedObjectType.GENERATE_CSR_RESPONSE
 ...
 */
@EmbeddedObjectTemplate(GENERATE_CSR_RESPONSE)
open class GenerateCSRResponseTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "CertificateCollection" to ResourceCollection(CERTIFICATES_COLLECTION),
                "CSRString" to ""
        ))
    }
}
