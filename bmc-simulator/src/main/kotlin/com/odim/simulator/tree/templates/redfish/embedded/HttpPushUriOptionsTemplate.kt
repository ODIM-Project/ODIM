 ...
 */
@EmbeddedObjectTemplate(HTTP_PUSH_URI_OPTIONS)
open class HttpPushUriOptionsTemplate : ResourceTemplate() {
    init {
        version(V1_4_0, embeddedObject(
                "HttpPushUriApplyTime" to embeddedObject(HTTP_PUSH_URI_APPLY_TIME)
        ))
    }
}
