 ...
 */
@EmbeddedObjectTemplate(IO_WORKLOAD_COMPONENT)
open class IOWorkloadComponentTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "IOAccessPattern" to null,
                "AverageIOBytes" to null,
                "PercentOfData" to null,
                "PercentOfIOPS" to null,
                "Duration" to null,
