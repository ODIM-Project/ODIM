 ...
 */
@EmbeddedObjectTemplate(IP_TRANSPORT_DETAILS)
open class IPTransportDetailsTemplate : ResourceTemplate() {
    init {
        version(V1_1_0, embeddedObject(
                "TransportProtocol" to "PCIe",
                "IPv4Address" to embeddedObject(IP_V4_ADDRESS),
                "IPv6Address" to embeddedObject(IP_V6_ADDRESS),
                "Port" to 0.00
        ))
    }
}
