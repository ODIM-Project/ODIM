 ...
 */
@EmbeddedObjectTemplate(INFINI_BAND)
open class InfiniBandTemplate : ResourceTemplate() {
    init {
        version(V1_5_0, embeddedObject(
                "PermanentPortGUID" to null,
                "PermanentNodeGUID" to null,
                "PermanentSystemGUID" to null,
                "PortGUID" to null,
                "NodeGUID" to null,
                "SystemGUID" to null,
                "SupportedMTUSizes" to embeddedArray(),
                "MTUSize" to null
        ))
    }
}
