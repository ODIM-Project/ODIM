 ...
 */
@EmbeddedObjectTemplate(INPUT_RANGE)
open class InputRangeTemplate : ResourceTemplate() {
    init {
        version(V1_1_0, embeddedObject(
                "InputType" to null,
                "MinimumVoltage" to null,
                "MaximumVoltage" to null,
                "MinimumFrequencyHz" to null,
                "MaximumFrequencyHz" to null,
                "OutputWattage" to null,
