...
import com.odim.simulator.tree.structure.EmbeddedObjectType.INTERLEAVE_SET
 ...
 */
@EmbeddedObjectTemplate(INTERLEAVE_SET)
open class InterleaveSetTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "Memory" to LinkableResource(ANY),
                "RegionId" to null,
                "OffsetMiB" to null,
                "SizeMiB" to null,
                "MemoryLevel" to 1
