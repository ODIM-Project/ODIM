 ...
 */
@EmbeddedObjectTemplate(MEMORY_SUMMARY)
open class MemorySummaryTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "TotalSystemMemoryGiB" to null,
                "Status" to embeddedObject(STATUS)
        ))
        version(V1_1_0, V1_0_0, embeddedObject(
                "MemoryMirroring" to null
        ))
        version(V1_4_0, V1_1_0, embeddedObject(
                "TotalSystemPersistentMemoryGiB" to null
        ))
        version(V1_8_0, V1_4_0, embeddedObject(
