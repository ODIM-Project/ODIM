 ...
 */
@EmbeddedObjectTemplate(METRIC_REPORT_METRIC_VALUE)
open class MetricReportMetricValueTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "MetricId" to null,
                "MetricValue" to null,
                "Timestamp" to null,
                "MetricProperty" to null,
                "MetricDefinition" to LinkableResource(METRIC_DEFINITION)
        ))
