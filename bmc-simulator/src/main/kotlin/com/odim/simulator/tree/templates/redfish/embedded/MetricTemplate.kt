 ...
 */
@EmbeddedObjectTemplate(METRIC)
open class MetricTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "MetricId" to null,
                "MetricProperties" to embeddedArray(),
                "CollectionFunction" to null,
                "CollectionDuration" to null,
                "CollectionTimeScope" to null
        ))
    }
}
