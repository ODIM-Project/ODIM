...
import com.odim.simulator.tree.structure.EmbeddedObjectType.OPERATION_APPLY_TIME_SUPPORT
 ...
 */
@EmbeddedObjectTemplate(OPERATION_APPLY_TIME_SUPPORT)
open class OperationApplyTimeSupportTemplate : ResourceTemplate() {
    init {
        version(V1_2_0, embeddedObject(
                "SupportedValues" to embeddedArray(),
                "MaintenanceWindowStartTime" to "2017-04-14T06:35:05Z",
                "MaintenanceWindowDurationInSeconds" to 0,
