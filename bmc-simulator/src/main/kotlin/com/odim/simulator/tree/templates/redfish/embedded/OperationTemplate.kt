...
import com.odim.simulator.tree.structure.ResourceType.FEATURES_REGISTRY

/**
 * This is generated class. Please don't edit it's contents.
 */
@EmbeddedObjectTemplate(OPERATION)
open class OperationTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "OperationName" to null,
                "PercentageComplete" to null,
                "AssociatedFeaturesRegistry" to LinkableResource(FEATURES_REGISTRY)
        ))
    }
}
