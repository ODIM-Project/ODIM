 ...
 */
@EmbeddedObjectTemplate(POWER_MANAGEMENT_POLICY)
open class PowerManagementPolicyTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "PolicyEnabled" to null,
                "MaxTDPMilliWatts" to null,
                "PeakPowerBudgetMilliWatts" to null,
                "AveragePowerBudgetMilliWatts" to null
        ))
    }
}
