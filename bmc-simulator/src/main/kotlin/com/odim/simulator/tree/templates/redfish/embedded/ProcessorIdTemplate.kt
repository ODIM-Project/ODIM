 ...
 */
@EmbeddedObjectTemplate(PROCESSOR_ID)
open class ProcessorIdTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "VendorId" to null,
                "IdentificationRegisters" to null,
                "EffectiveFamily" to null,
                "EffectiveModel" to null,
                "Step" to null,
                "MicrocodeInfo" to null
        ))
        version(V1_10_0, V1_0_0, embeddedObject(
                "ProtectedIdentificationNumber" to null
        ))
    }
}
