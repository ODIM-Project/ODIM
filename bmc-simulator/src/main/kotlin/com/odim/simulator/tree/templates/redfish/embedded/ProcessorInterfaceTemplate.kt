...
import com.odim.simulator.tree.structure.EmbeddedObjectType.ETHERNET_INTERFACE
 ...
 */
@EmbeddedObjectTemplate(PROCESSOR_INTERFACE)
open class ProcessorInterfaceTemplate : ResourceTemplate() {
    init {
        version(V1_4_0, embeddedObject(
                "InterfaceType" to null,
                "PCIe" to embeddedObject(PCIE_INTERFACE),
                "Ethernet" to embeddedObject(ETHERNET_INTERFACE)
        ))
    }
}
