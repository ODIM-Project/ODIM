 ...
 */
@EmbeddedObjectTemplate(PROCESSOR_SUMMARY)
open class ProcessorSummaryTemplate : ResourceTemplate() {
    init {
        ...
        version(V1_5_0, V1_0_0, embeddedObject(
                "LogicalProcessorCount" to null
        ))
        version(V1_7_0, V1_5_0, embeddedObject(
