 ...
 */
@EmbeddedObjectTemplate(REGION_SET)
open class RegionSetTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "RegionId" to null,
                "MemoryClassification" to null,
                "OffsetMiB" to null,
                "SizeMiB" to null,
                "PassphraseState" to null
        ))
        version(V1_5_0, V1_0_0, embeddedObject(
                "PassphraseEnabled" to null
        ))
    }
}
