...
import com.odim.simulator.tree.structure.EmbeddedObjectType.RENEW_RESPONSE
 ...
 */
@EmbeddedObjectTemplate(RENEW_RESPONSE)
open class RenewResponseTemplate : ResourceTemplate() {
    init {
