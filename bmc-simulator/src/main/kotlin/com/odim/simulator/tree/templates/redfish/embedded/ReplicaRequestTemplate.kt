...
import com.odim.simulator.tree.structure.EmbeddedObjectType.REPLICA_REQUEST
 ...
 */
@EmbeddedObjectTemplate(REPLICA_REQUEST)
open class ReplicaRequestTemplate : ResourceTemplate() {
    init {
        version(V1_1_0, embeddedObject(
                "ReplicaSource" to LinkableResource(ANY),
                "ReplicaName" to null
        ))
    }
}
