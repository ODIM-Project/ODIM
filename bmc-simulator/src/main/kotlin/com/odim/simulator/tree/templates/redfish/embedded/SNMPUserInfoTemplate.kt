...
import com.odim.simulator.tree.structure.EmbeddedObjectType.SNMP_USER_INFO
import com.odim.simulator.tree.structure.Resource.Companion.embeddedObject

/**
 * This is generated class. Please don't edit it's contents.
 */
@EmbeddedObjectTemplate(SNMP_USER_INFO)
open class SNMPUserInfoTemplate : ResourceTemplate() {
    init {
        version(V1_4_0, embeddedObject(
                "AuthenticationKey" to null,
                "AuthenticationProtocol" to null,
                "EncryptionKey" to null,
                "EncryptionProtocol" to null
        ))
        version(V1_5_0, V1_4_0, embeddedObject(
                "AuthenticationKeySet" to false,
                "EncryptionKeySet" to false
        ))
    }
}
