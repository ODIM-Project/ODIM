 ...
 */
@EmbeddedObjectTemplate(SSE_FILTER_PROPERTIES_SUPPORTED)
open class SSEFilterPropertiesSupportedTemplate : ResourceTemplate() {
    init {
        version(V1_2_0, embeddedObject(
                "EventType" to false,
                "MetricReportDefinition" to false,
                "RegistryPrefix" to false,
                "ResourceType" to false,
                "EventFormatType" to false,
                "MessageId" to false,
                "OriginResource" to false
        ))
        version(V1_4_0, V1_2_0, embeddedObject(
                "SubordinateResources" to false
        ))
    }
}
