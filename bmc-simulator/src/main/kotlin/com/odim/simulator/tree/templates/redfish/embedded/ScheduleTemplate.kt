 ...
 */
@EmbeddedObjectTemplate(SCHEDULE)
open class ScheduleTemplate : ResourceTemplate() {
    init {
        version(V1_0_0, embeddedObject(
                "Name" to null,
                "Lifetime" to null,
                "MaxOccurrences" to null,
                "InitialStartTime" to null,
                "RecurrenceInterval" to null,
                "EnabledDaysOfWeek" to embeddedArray(),
                "EnabledDaysOfMonth" to embeddedArray(),
                "EnabledMonthsOfYear" to embeddedArray()
        ))
        version(V1_0_1, V1_0_0)
        version(V1_1_0, V1_0_0, embeddedObject(
                "EnabledIntervals" to embeddedArray()
        ))
