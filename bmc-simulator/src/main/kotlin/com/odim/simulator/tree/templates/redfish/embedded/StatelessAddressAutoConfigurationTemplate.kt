 ...
 */
@EmbeddedObjectTemplate(STATELESS_ADDRESS_AUTO_CONFIGURATION)
open class StatelessAddressAutoConfigurationTemplate : ResourceTemplate() {
    init {
        version(V1_4_0, embeddedObject(
                "IPv4AutoConfigEnabled" to null,
                "IPv6AutoConfigEnabled" to null
        ))
    }
}
