 ...
 */
@EmbeddedObjectTemplate(SUPPORTED_LINK_CAPABILITIES)
open class SupportedLinkCapabilitiesTemplate : ResourceTemplate() {
    init {
        ...
        version(V1_2_0, V1_0_0, embeddedObject(
                "CapableLinkSpeedMbps" to embeddedArray(),
                "AutoSpeedNegotiation" to null
        ))
    }
}
