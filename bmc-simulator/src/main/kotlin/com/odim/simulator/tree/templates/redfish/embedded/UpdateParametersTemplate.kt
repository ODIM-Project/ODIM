...
import com.odim.simulator.tree.structure.EmbeddedObjectType.UPDATE_PARAMETERS
 ...
 */
@EmbeddedObjectTemplate(UPDATE_PARAMETERS)
open class UpdateParametersTemplate : ResourceTemplate() {
    init {
        version(V1_6_0, embeddedObject(
                "Targets" to embeddedArray()
        ))
        version(V1_8_0, V1_6_0, embeddedObject(
