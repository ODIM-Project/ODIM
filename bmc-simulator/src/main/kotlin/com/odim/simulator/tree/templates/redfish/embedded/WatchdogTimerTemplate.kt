 ...
 */
@EmbeddedObjectTemplate(WATCHDOG_TIMER)
open class WatchdogTimerTemplate : ResourceTemplate() {
    init {
        version(V1_5_0, embeddedObject(
                "FunctionEnabled" to null,
                "WarningAction" to null,
                "TimeoutAction" to null,
