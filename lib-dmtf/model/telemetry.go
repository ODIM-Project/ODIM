...
type NumericThresholds struct{
	LowerCritical				LowerCritical		`json:"LowerCritical,omitempty"`
	LowerWarning				LowerWarning		`json:"LowerWarning,omitempty"`
	UpperCritical				UpperCritical		`json:"UpperCritical,omitempty"`
	UpperWarning				UpperWarning		`json:"UpperWarning,omitempty"`
