...
const (
	...
	InsufficientPrivileges = "Base.1.11.0.InsufficientPrivilege"
	...
	ResourceCannotBeModified = "Base.1.11.0.ResourceCannotBeModified"
	...
	UnauthorizedLoginAttempt = "Base.1.11.0.UnauthorizedLoginAttempt"
	// Unauthorized defines the status message at the time of Unauthorized service wants to perform task
	Unauthorized = "Base.1.11.0.Unauthorized"
