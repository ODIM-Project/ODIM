...
helm.sh/chart: {{ include "aggregation.chart" . }}
...
app.kubernetes.io/name: {{ include "aggregation.name" . }}
...
{{- default (include "aggregation.fullname" .) .Values.serviceAccount.name }}
{{- else }}
