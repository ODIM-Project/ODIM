...
//func (c *client) Get(uri string, target interface{}) *CommonError {
//	path, err := url.Parse(uri)
//	if err != nil {
//		ce := CreateError(GeneralError, fmt.Sprintf("couldn't parse %s into URL object: %s", uri, err))
//		return &ce
//	}
//	baseURL, err := url.Parse(c.baseURL)
//	if err != nil {
//		ce := CreateError(GeneralError, fmt.Sprintf("couldn't parse %s into URL object: %s", baseURL, err))
//		return &ce
//	}
//
//	req := http.Request{
...
//	if err != nil {
//		ce := CreateError(GeneralError, fmt.Sprintf("cannot execute GET %s: %s", req.URL.String(), err))
//		return &ce
//	}
//
//	if resp.StatusCode != http.StatusOK {
//		ce := CreateError(GeneralError, fmt.Sprintf("GET %s operation finished with status != 200", req.URL.String()))
//		return &ce
//	}
//
//	dec := json.NewDecoder(resp.Body)
...
//	err = dec.Decode(tempTarget)
//	if err != nil {
//		ce := CreateError(GeneralError, fmt.Sprintf("Cannot decode body of GET %s operation: %s", req.URL.String(), err))
//		return &ce
//	}
//
//	//todo: translator comes form config, translation implemented in response decorator
//	newBody := strings.Replace(string(*tempTarget), "/redfish/", "/ODIM/", -1)
//
//	err = json.Unmarshal([]byte(newBody), target)
//	if err != nil {
//		ce := CreateError(GeneralError, fmt.Sprintf("Cannot decode body of GET %s operation: %s", req.URL.String(), err))
//		return &ce
//	}
...
//}
//
//func (c *client) Post(uri string, body interface{}, target interface{}) *CommonError {
//
//}
