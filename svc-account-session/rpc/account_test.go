...
func Test_validateUpdateLastUsedTimeError(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantErrorMessage:  "error while updating last used time of session: fakeError",
