...
require (
	...
	github.com/ODIM-Project/ODIM/lib-utilities v0.0.0-20200930102352-fdedf684cec7
	github.com/ODIM-Project/ODIM/lib-rest-client v0.0.0-20200727110501-4599893e44fd
