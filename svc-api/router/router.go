...
func Router() *iris.Application {
	...
	managers.Any("/{id}/EthernetInterfaces/{rid}", manager.ManagersMethodNotAllowed)
	...
	managers.Any("/{id}/NetworkProtocol/{rid}", manager.ManagersMethodNotAllowed)
	...
	managers.Any("/{id}/HostInterfaces/{rid}", manager.ManagersMethodNotAllowed)
	...
	managers.Any("/{id}/SerialInterfaces/{rid}", manager.ManagersMethodNotAllowed)
