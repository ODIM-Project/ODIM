...
func Router() *iris.Application {
	...
	managers.Get("/{id}/LogServices/{rid}/Entries", middleware.ResourceRateLimiter, manager.GetManagersResource)
	managers.Get("/{id}/LogServices/{rid}/Entries/{rid2}", middleware.ResourceRateLimiter, manager.GetManagersResource)
