...
func Router() *iris.Application {
	...
	chassis.Get("/{id}/NetworkAdapters/{rid}/NetworkDeviceFunctions", cha.GetChassisResource)
    chassis.Get("/{id}/NetworkAdapters/{rid}/NetworkPorts", cha.GetChassisResource)
    chassis.Get("/{id}/NetworkAdapters/{rid}/NetworkDeviceFunctions/{id2}", cha.GetChassisResource)
    chassis.Get("/{id}/NetworkAdapters/{rid}/NetworkPorts/{id2}", cha.GetChassisResource)
	...
	chassis.Any("/{id}/NetworkAdapters/{rid}/NetworkDeviceFunctions", handle.ChassisMethodNotAllowed)
	chassis.Any("/{id}/NetworkAdapters/{rid}/NetworkPorts", handle.ChassisMethodNotAllowed)
	chassis.Any("/{id}/NetworkAdapters/{rid}/NetworkDeviceFunctions/{id2}", handle.ChassisMethodNotAllowed)
	chassis.Any("/{id}/NetworkAdapters/{rid}/NetworkPorts/{id2}", handle.ChassisMethodNotAllowed)
