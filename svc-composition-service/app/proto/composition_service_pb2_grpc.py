...
class CompositionStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetCompositionService = channel.unary_unary(
            ...
            request_serializer=composition__service__pb2.
            GetCompositionServiceRequest.SerializeToString,
            response_deserializer=composition__service__pb2.
            CompositionServiceResponse.FromString,
        )
        self.GetCompositionResource = channel.unary_unary(
            '/Composition/GetCompositionResource',
            request_serializer=composition__service__pb2.
            GetCompositionResourceRequest.SerializeToString,
            response_deserializer=composition__service__pb2.
            CompositionServiceResponse.FromString,
        )
        self.CreateCompositionResource = channel.unary_unary(
            ...
            request_serializer=composition__service__pb2.
            CreateCompositionResourceRequest.SerializeToString,
            response_deserializer=composition__service__pb2.
            CompositionServiceResponse.FromString,
        )
        self.DeleteCompositionResource = channel.unary_unary(
            ...
            request_serializer=composition__service__pb2.
            DeleteCompositionResourceRequest.SerializeToString,
            response_deserializer=composition__service__pb2.
            CompositionServiceResponse.FromString,
        )
        self.Compose = channel.unary_unary(
            '/Composition/Compose',
            request_serializer=composition__service__pb2.ComposeRequest.
            SerializeToString,
            response_deserializer=composition__service__pb2.
            CompositionServiceResponse.FromString,
        )
...
def add_CompositionServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=composition__service__pb2.
            GetCompositionServiceRequest.FromString,
            response_serializer=composition__service__pb2.
            CompositionServiceResponse.SerializeToString,
        ),
        'GetCompositionResource':
        grpc.unary_unary_rpc_method_handler(
            servicer.GetCompositionResource,
            request_deserializer=composition__service__pb2.
            GetCompositionResourceRequest.FromString,
            response_serializer=composition__service__pb2.
            CompositionServiceResponse.SerializeToString,
        ),
        ...
        grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=composition__service__pb2.
            CreateCompositionResourceRequest.FromString,
            response_serializer=composition__service__pb2.
            CompositionServiceResponse.SerializeToString,
        ),
        'DeleteCompositionResource':
        grpc.unary_unary_rpc_method_handler(
            servicer.DeleteCompositionResource,
            request_deserializer=composition__service__pb2.
            DeleteCompositionResourceRequest.FromString,
            response_serializer=composition__service__pb2.
            CompositionServiceResponse.SerializeToString,
        ),
        'Compose':
        grpc.unary_unary_rpc_method_handler(
            servicer.Compose,
            request_deserializer=composition__service__pb2.ComposeRequest.
            FromString,
            response_serializer=composition__service__pb2.
            CompositionServiceResponse.SerializeToString,
        ),
...
class Composition(object):
    ...
    def GetCompositionService(request,
        ...
        return grpc.experimental.unary_unary(
            request, target, '/Composition/GetCompositionService',
            composition__service__pb2.GetCompositionServiceRequest.
            SerializeToString,
    ...
    def GetCompositionResource(request,
                               ...
                               metadata=None):
        return grpc.experimental.unary_unary(
            request, target, '/Composition/GetCompositionResource',
            composition__service__pb2.GetCompositionResourceRequest.
            SerializeToString,
            composition__service__pb2.CompositionServiceResponse.FromString,
            options, channel_credentials, insecure, call_credentials,
            compression, wait_for_ready, timeout, metadata)
    ...
    def CreateCompositionResource(request,
                                  ...
                                  metadata=None):
        return grpc.experimental.unary_unary(
            request, target, '/Composition/CreateCompositionResource',
            composition__service__pb2.CreateCompositionResourceRequest.
            SerializeToString,
            composition__service__pb2.CompositionServiceResponse.FromString,
            options, channel_credentials, insecure, call_credentials,
            compression, wait_for_ready, timeout, metadata)
    ...
    def DeleteCompositionResource(request,
                                  ...
                                  metadata=None):
        return grpc.experimental.unary_unary(
            request, target, '/Composition/DeleteCompositionResource',
            composition__service__pb2.DeleteCompositionResourceRequest.
            SerializeToString,
            composition__service__pb2.CompositionServiceResponse.FromString,
            options, channel_credentials, insecure, call_credentials,
            compression, wait_for_ready, timeout, metadata)
    ...
    def Compose(request,
                ...
                metadata=None):
        return grpc.experimental.unary_unary(
            request, target, '/Composition/Compose',
