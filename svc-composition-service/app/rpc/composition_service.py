        ...
        if request.URL:
            ...
            if request.resourceID:
                ...
                if segments[-1] == "ResourceBlocks":
                    response, code = self.resourceblock.get_resource_block_collection(request.URL)
                ...
                # FreePool Collection
                    ...
                    response, code = self.cs.get_composition_reservations_collection(request.URL)
    ...
    def DeleteCompositionResource(self, request: pb2.DeleteCompositionResourceRequest, context: grpc.ServicerContext) -> pb2.CompositionServiceResponse:
        ...
        if request.URL:
            ...
            if segments[-2] == "ResourceBlocks":
                ...
                response, code = self.resourceblock.delete_resource_block(request.URL)
            # ResourceZone Instance
            elif segments[-2] == "ResourceZones":
                # Delete Resource Zone
                response, code = self.resourcezone.delete_resource_zone(request.URL)
