...
func TestDeleteEventSubscription(t *testing.T) {
	...
	resp = pc.DeleteEventSubscriptionsDetails(evcommon.MockContext(), req1, "admin", "1225122")
	...
	resp = pc.DeleteEventSubscriptionsDetails(evcommon.MockContext(), req2, "admin", "1225122")
...
func TestDeleteEventSubscriptionOnDeletedServer(t *testing.T) {
	...
	resp := pc.DeleteEventSubscriptions(evcommon.MockContext(), req, "1225122")
	...
	resp = pc.DeleteEventSubscriptions(evcommon.MockContext(), req1, "1225122")
...
func TestDeleteEventSubscriptionOnFabrics(t *testing.T) {
	...
	resp := pc.DeleteEventSubscriptionsDetails(evcommon.MockContext(), req, "admin", "test")
	assert.Equal(t, http.StatusOK, int(resp.StatusCode), "Status Code should be StatusOK")
}
...
func TestExternalInterfaces_resubscribeFabricsSubscription(t *testing.T) {
	...
	err := pc.resubscribeFabricsSubscription(evcommon.MockContext(), event, "/fabric/scascascsaa", "admin", "test", false)
	assert.Nil(t, err)
	err = pc.resubscribeFabricsSubscription(evcommon.MockContext(), event, "/redfish/v1/Fabrics/6d4a0a66-7efa-578e-83cf-44dc68d2874e", "admin", "test", false)
	assert.Nil(t, err)
}
...
func TestExternalInterfaces_subscribe(t *testing.T) {
	...
	_, err := pc.subscribe(evcommon.MockContext(), event, "/redfish/v1/Systems/6d4a0a66-7efa-578e-83cf-44dc68d2874e.1", false, "valid", "admin", "test", "test")
	assert.Nil(t, err)
